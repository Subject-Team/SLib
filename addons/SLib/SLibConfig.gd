...
func _enter_tree():
	...
	if FileAccess.file_exists(CONFIG_FILES["FileLocations"]):
		...
		file.close()
	ProjectSettings.set("Addons/SLib/Defaults", defaults)
	ProjectSettings.set_initial_value("Addons/SLib/Defaults", defaults)
	ProjectSettings.set("Addons/SLib/FileLocations", file_locations)
	ProjectSettings.set_initial_value("Addons/SLib/FileLocations", file_locations)
...
func _exit_tree():
	...
	defaults = ProjectSettings.get_setting("Addons/SLib/Defaults")
	file_locations = ProjectSettings.get_setting("Addons/SLib/FileLocations")
